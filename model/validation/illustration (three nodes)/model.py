...
report.write_results_to_folder(model, "Verification")

"""PRINT (NODAL) GAS SHADOW PRICE FOR THE FIRST YEAR"""
for node in model.set_node_hp:
    print("Node: {} in Year {}: {}".format(node, 2050, np.round(model.dual[model.c_limit_high_demand[node, 2050, 1]], 1)))
