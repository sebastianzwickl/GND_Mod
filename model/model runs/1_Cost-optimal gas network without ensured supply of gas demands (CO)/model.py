...
for node in model.set_node_hp:
    print("Node: {} in Year {}: {}".format(node, 2050, model.dual[model.c_limit_high_demand[node, 2050, 1]]))
    print("Gasverbrauch (versorgt): {}".format(model.var_demand_high[node, 2050, 1].value))
    print("Gasverbrauch (total): {}".format(model.par_demand_high[node, 2050, 1]))
